...
//	}
	...
	public String toString() {
		return "HomeDto [marsApiRoverData=" + marsApiRoverData + ", marsSol=" + marsSol + ", defaultCheck1="
				+ defaultCheck1 + ", userId=" + userId + ", cameraFhaz=" + cameraFhaz + ", cameraRhaz=" + cameraRhaz
